 ...
 * 发送邮件到【易邮邮箱服务器】工具类
 * ------------------------------------------------------------
 * -------------------------------------- 使用方法： 1_将本类放在com.itheima.shop.util包下
 * 2_导入mail.jar到工程的/WEB-INF/lib/下
 * 3_写一个Demo01类带main函数，调用MailEyouUtil.sendMail("发件人邮箱","收件人邮箱","邮件主题","支持HTML格式的邮件内容"
 * ) 如：MailEyouUtil.sendMail("zhaojun@abc.com","zhaoyun@abc.com","测试一下",
 * "<b>你好</b>")
 * ------------------------------------------------------------------
 * --------------------------------
 */
public final class MailEyouUtil {
	...
	/**
	 * 发送邮件 参数一：发件人邮箱 参数二：收件人邮箱 参数三：邮件主题 参数四：邮件内容
	 */
